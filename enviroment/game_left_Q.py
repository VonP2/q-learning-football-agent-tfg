...
class GameleftQ:
    ...
    def __init__(self, window, window_width, window_height):
        ...
        self.players = [self.player1_team_left]
    ...
    def moveToBallReward(self, current_frame):
        ...
        state = self.player1_team_left.get_state(self.ball)
    ...
    def loop(self,agentL, footballGame):
        self.agentL = agentL
        ...
        while True:
                ...
                #footballGame.train_ai_single_agent(self.agentL,self.done)
                #footballGame.play_ai_single_agent(self.agentL)
                footballGame.test_agent(self.agentL, self.actions_counter)
