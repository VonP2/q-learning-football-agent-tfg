...
class Game:
    ...
    def __init__(self, window, window_width, window_height):
        ...
        self.ball = Ball(self.all_sprites,self.collision_sprites,self.players,goalL, goalR, self.BALL_RADIUS, self.BALL_COLOR, self.BALL_MAX_SPEED, self.BALL_ORIGINAL_X, self.BALL_ORIGINAL_Y, self.BALL_DECELERATION, self)
        for player in self.players:
    ...
    def loop(self,agentL, agentR, footballGame):
        ...
        while True:
            ...
            #footballGame.test_ai(self.agentL, self.agentR,self.done)
            #footballGame.play_ai_single_agent(self.agentL, self.agentR)
            footballGame.test_agent(self.agentL, self.agentR, self.actions_counter)
